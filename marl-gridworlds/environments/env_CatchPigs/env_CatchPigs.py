...
class EnvCatchPigs(object):
    ...
    def get_agt1_obs(self):
        ...
        if self.if_PO == False:
            ...
            for k in range(5):
                if (
                    self.raw_occupancy[self.agt1_pos[0] - 2][self.agt1_pos[1] + k - 2]
                    == 1
                ):
                    self.paint_block(obs, 4 - k, 0)
                if (
                    self.raw_occupancy[self.agt1_pos[0] - 1][self.agt1_pos[1] + k - 2]
                    == 1
                ):
    ...
    def get_agt2_obs(self):
        ...
        if self.if_PO == False:
            ...
            for k in range(5):
                if (
                    self.raw_occupancy[self.agt2_pos[0] - 2][self.agt2_pos[1] + k - 2]
                    == 1
                ):
                    self.paint_block(obs, 4 - k, 0)
                if (
                    self.raw_occupancy[self.agt2_pos[0] - 1][self.agt2_pos[1] + k - 2]
                    == 1
                ):
                    self.paint_block(obs, 4 - k, 1)
    ...
    def get_pig_obs(self):
        ...
        if self.if_PO == False:
            ...
            for k in range(5):
                if (
                    self.raw_occupancy[self.pig_pos[0] - 2][self.pig_pos[1] + k - 2]
                    == 1
                ):
                    self.paint_block(obs, 4 - k, 0)
                if (
                    self.raw_occupancy[self.pig_pos[0] - 1][self.pig_pos[1] + k - 2]
                    == 1
                ):
                    self.paint_block(obs, 4 - k, 1)
    ...
    def get_full_obs(self):
        ...
        self.paint_agt2(
            obs, self.map_size - self.agt2_pos[1] - 1, self.agt2_pos[0], self.agt2_ori
        )
        self.paint_pig(
