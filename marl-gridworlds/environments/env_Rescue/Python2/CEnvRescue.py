...
class CEnvRescue(_object):
    ...
    if _newclass:
        map = _swig_property(
            _CEnvRescue.CEnvRescue_map_get, _CEnvRescue.CEnvRescue_map_set
        )
    ...
    if _newclass:
        N_agent = _swig_property(
            _CEnvRescue.CEnvRescue_N_agent_get, _CEnvRescue.CEnvRescue_N_agent_set
        )
    ...
    if _newclass:
        N_human = _swig_property(
            _CEnvRescue.CEnvRescue_N_human_get, _CEnvRescue.CEnvRescue_N_human_set
        )
    ...
    if _newclass:
        agent_list = _swig_property(
            _CEnvRescue.CEnvRescue_agent_list_get, _CEnvRescue.CEnvRescue_agent_list_set
        )
    ...
    if _newclass:
        human_list = _swig_property(
            _CEnvRescue.CEnvRescue_human_list_get, _CEnvRescue.CEnvRescue_human_list_set
        )
    ...
    if _newclass:
        obs_size = _swig_property(
            _CEnvRescue.CEnvRescue_obs_size_get, _CEnvRescue.CEnvRescue_obs_size_set
        )
    __swig_setmethods__["obs"] = _CEnvRescue.CEnvRescue_obs_set
    __swig_getmethods__["obs"] = _CEnvRescue.CEnvRescue_obs_get
    if _newclass:
        obs = _swig_property(
            _CEnvRescue.CEnvRescue_obs_get, _CEnvRescue.CEnvRescue_obs_set
        )
    ...
    if _newclass:
        global_obs = _swig_property(
            _CEnvRescue.CEnvRescue_global_obs_get, _CEnvRescue.CEnvRescue_global_obs_set
        )
    ...
    if _newclass:
        edge_blk_num = _swig_property(
            _CEnvRescue.CEnvRescue_edge_blk_num_get,
            _CEnvRescue.CEnvRescue_edge_blk_num_set,
        )
    ...
    if _newclass:
        if_pick = _swig_property(
            _CEnvRescue.CEnvRescue_if_pick_get, _CEnvRescue.CEnvRescue_if_pick_set
        )
    ...
    if _newclass:
        carry_human_id = _swig_property(
            _CEnvRescue.CEnvRescue_carry_human_id_get,
            _CEnvRescue.CEnvRescue_carry_human_id_set,
        )
    ...
    if _newclass:
        picked_by = _swig_property(
            _CEnvRescue.CEnvRescue_picked_by_get, _CEnvRescue.CEnvRescue_picked_by_set
        )
    ...
    if _newclass:
        is_free = _swig_property(
            _CEnvRescue.CEnvRescue_is_free_get, _CEnvRescue.CEnvRescue_is_free_set
        )
